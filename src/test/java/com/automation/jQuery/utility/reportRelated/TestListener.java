...
// Extent Report
        ...
        extent.setSystemInfo("User Name", "Gulzira");
        htmlReporter.config().setEncoding("utf-8");
        htmlReporter.config().setJS("js-string");
        htmlReporter.config().setDocumentTitle("Test Automation Report");
        htmlReporter.config().setReportName("jQuery Extent Report");
    ...
    public void onTestStart(ITestResult result) {
        ...
        info("Test Case: " + TestCaseID + " Started");
    }

    public void onTestSuccess(ITestResult result) {
        String TestCaseID = result.getName();
        info("Test Case: " + TestCaseID + " Passed");
    ...
    public void onTestFailure(ITestResult result) {
        String TestCaseID = result.getName();
        info("Test Case: " + TestCaseID + " Failed");
        logger.getModel().setEndTime(getTime(result.getEndMillis()));
...
// To add screenshot in the extent report
    ...
    public void onTestSkipped(ITestResult result) {
        String TestCaseID = result.getName();
        info("Test Case: " + TestCaseID + " Skipped");
