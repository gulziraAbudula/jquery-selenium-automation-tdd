...
public class AlertHandlerUtil {
    ...
    public AlertHandlerUtil(WebDriver driver) {
        this.driver = driver;
    }

    /**
     * Returns and switch to the alert object
     *
     * @return Alert object
     */
    ...
    /**
     * Clicks the NO or negation button on the alert box
     */
    ...
    /**
     * Checks whether alert is present of not
     *
    ...
    /**
     * If the alert box is present, it will submit a Strings and accepts the alert
